...
% \section{Sistem Pengelolaan Tugas Akhir dan Laboratorium}

% \subsection{SITASI (Sistem Informasi Tugas Akhir)}
% SITASI adalah sistem pengelolaan Tugas Akhir Program Studi Sistem Informasi UIN Sultan Syarif Kasim Riau yang dikembangkan dengan prinsip "Dari mahasiswa, Oleh mahasiswa, dan Untuk mahasiswa". Sistem ini menjadi sarana pembelajaran pengembangan sistem informasi bagi mahasiswa dan dapat diakses di https://sitasi.uin-suska.ac.id \cite{web-prodi}.
...
% \subsection{SmartTA (Sistem Pengecekan Penulisan Tugas Akhir)}
% SmartTA adalah aplikasi untuk mendeteksi kesalahan penulisan dalam laporan Tugas Akhir, seperti gambar/tabel yang tidak dirujuk, label yang sama, dan kesalahan format. Sistem ini membantu mengurangi beban dosen pembimbing dan Koordinator Tugas Akhir dalam menjaga kualitas laporan \cite{web-prodi}.
...
% \subsection{SIKAPE (Sistem Kerja Praktek)}
% SIKAPE adalah sistem manajemen dan administrasi Kerja Praktek Program Studi Sistem Informasi yang bertujuan mempermudah proses Kerja Praktek dengan memangkas alur yang sebelumnya dilakukan secara manual. Sistem ini direncanakan akan diintegrasikan dengan SITASI \cite{web-prodi}.
...
% \subsection{SIREPO (Sistem Repositori)}
% SIREPO adalah sistem penyimpanan digital untuk dokumen penelitian, Tugas Akhir, Kerja Praktek, dan dokumen penting laboratorium. Dibangun sebagai \textit{custom software open source} untuk mengatasi keterbatasan ruang penyimpanan fisik dan meningkatkan keamanan dokumen. Dapat diakses di https://repo.lab-si.uin-suska.ac.id \cite{web-prodi}.
...
\begin{enumerate}
	\item \textit{Use Case Diagram} \\
	      ...
	      \begin{longtable}{c c c l}
		      ...
		      \endhead
		      %
		      1  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 1.22cm, width= 0.91cm]{konten/gambar/uc1.jpg} \end{tabular} & \textit{Actor}          & \begin{tabular}[c]{@{}l@{}}Menspesifikasikan himpunan peran yang\\ pengguna mainkan ketika berinteraksi den-\\ gan use case.\end{tabular}                                                                                  \\
		      2  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 0.21cm, width= 0.91cm]{konten/gambar/uc2.png} \end{tabular} & \textit{Depedency}      & \begin{tabular}[c]{@{}l@{}}Hubungan dimana perubahan terjadi pada\\ suatu elemen yang mandiri (independent)\\ akan mempengaruhi elemen yang bergan-\\ tung padanya elemen yang tidak mandiri\\ (independent).\end{tabular} \\
		      3  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 0.21cm, width= 0.91cm]{konten/gambar/uc3.png} \end{tabular} & \textit{Generelization} & \begin{tabular}[c]{@{}l@{}}Hubungan dimana objek anak (descendent)\\ berbagi prilaku dan struktur dari data objek\\ yang ada di atasnya objek induk (ancestor).\end{tabular}                                               \\
		      4  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 0.21cm, width= 0.91cm]{konten/gambar/uc4.png} \end{tabular} & \textit{Include}        & \begin{tabular}[c]{@{}l@{}}Menspesifikasikan bahwa use case sumber\\ secara eksplisit.\end{tabular}                                                                                                                        \\
		      5  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 0.21cm, width= 0.91cm]{konten/gambar/uc5.png} \end{tabular} & \textit{Extend}         & \begin{tabular}[c]{@{}l@{}}Menspesifikasikan bahwa use case target\\ memperluas perilaku dari use case sumber\\ pada suatu titik yang diberikan.\end{tabular}                                                              \\
		      6  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 0.21cm, width= 0.91cm]{konten/gambar/uc6.png} \end{tabular} & \textit{Association}    & \begin{tabular}[c]{@{}l@{}}Apa yang menghubungkan antara objek satu\\ dengan objek lainnya.\end{tabular}                                                                                                                   \\
		      7  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 1.42cm, width= 0.91cm]{konten/gambar/uc7.png} \end{tabular} & \textit{System}         & \begin{tabular}[c]{@{}l@{}}Menspesifikasikan paket yang menampilkan\\ sistem secara terbatas.\end{tabular}                                                                                                                 \\
		      8  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 0.52cm, width= 0.98cm]{konten/gambar/uc8.png} \end{tabular} & \textit{Use Case}       & \begin{tabular}[c]{@{}l@{}}Deskripsi dari urutan aksi-aksi yang ditam-\\ pilkan sistem yang menghasilkan suatu hasil\\ yang terukur bagi suatu aktor.\end{tabular}                                                         \\
		      9  & \begin{tabular}[c]{@{}l@{}} \includegraphics[height= 0.48cm, width= 1.06cm]{konten/gambar/uc9.jpg} \end{tabular} & \textit{Collaboration}  & \begin{tabular}[c]{@{}l@{}}Interaksi aturan-aturan dan elemen lain\\ yang bekerja sama untuk menyediakan per-\\ ilaku yang lebih bear dari jumlah dan\\ elemen-elemennya (sinergi).\end{tabular}                           \\
		      \hline
	      \end{longtable}
	      }
